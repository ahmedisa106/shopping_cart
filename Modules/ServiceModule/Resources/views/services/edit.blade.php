        ...
        <div class="box box-info">
            ...
            <form class="form-horizontal" action="{{route('services.update',$service->id)}}" method="POST"
                ...
                <div class="box-body">
                                ...
                                @foreach($langs as $lang)
                                    <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input value="{{$service->translate($lang->dispaly_lang)['title']}}" type="text" autocomplete="off" class="form-control" placeholder=" @lang('commonmodule::site.title')" required name="{{$lang->display_lang}}[title]"
                                                >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor" name="{{$lang->display_lang}}[description]" placeholder="@lang('commonmodule::site.description')">{{$service->translate($lang->display_lang)['description']}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="form-group">
                        {{--Status--}}
                        <label class="control-label col-sm-2" for="status">Category : </label>
                        <div class="col-sm-8">

                            <select class="form-control" name="service_cat_id">
                                <option value="">select Category</option>
                                @foreach($cats as $cat)
                                    <option value="{{$cat->id}}" {{($cat->id == $service->service_cat_id) ? 'selected' :''}}>{{$cat->title}}</option>
                                @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <select class="form-control" name="status">
                                <option value="0" {{$service->status == 0 ?'selected':''}}>@lang('commonmodule::site.unactive')</option>
                                <option value="1" {{$service->status == 1 ?'selected':''}}>@lang('commonmodule::site.active')</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            ...
                            <br>
                            <img style="max-width: 200px; max-height:100px;" src="{{asset('/images/services/'.$service->photo)}}">
                        </div>

                        <label class="control-label col-sm-2" for="img">cover</label>
                        <div class="col-sm-3">
                            <input type="file" autocomplete="off" class="" name="cover">
                            <br>
                            <img style="max-width: 200px; max-height:100px;" src="{{asset('/images/services/'.$service->cover)}}">
                        </div>
                    </div>
