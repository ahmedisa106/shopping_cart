                ...
                <div class="col d-flex flex-row">
                    ...
                    <div class="top_bar_content ml-auto">
                        ...
                        <div class="top_bar_user">
                            <div class="user_icon"><img src="{{asset('/assets/front')}}/images/user.svg" alt=""></div>
                            @guest()
                    ...
                    <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                        ...
                        <div class="cart">
                            <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                <div class="cart_icon">
                                    <img src="{{asset('/assets/front')}}/images/cart.png" alt="">
                                    <div id="cart_count" class="cart_count"><span>{{Cart::getContent()->count()}}</span></div>
                                </div>
                    ...
                    <div class="page_menu_content">
                        ...
                        <ul class="page_menu_nav">
                            ...
                            <li class="page_menu_item">
                                <a href="">asdasd<i class="fa fa-angle-down"></i></a>
                            </li>
                            <li class="page_menu_item has-children">
                        ...
                        <div class="menu_contact">
                            <div class="menu_contact_item">
                                <div class="menu_contact_icon"><img src="{{asset('/assets/front')}}/images/phone_white.png" alt=""></div>
                                +38 068 005 3570
                            </div>
                            <div class="menu_contact_item">
                                <div class="menu_contact_icon"><img src="{{asset('/assets/front')}}/images/mail_white.png" alt=""></div>
