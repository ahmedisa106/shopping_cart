            ...
            <form class="form-horizontal" action="{{route('categories.store')}}" method="POST"
                ...
                <div class="box-body">
                                ...
                                @foreach($langs as $lang)
                                    <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" autocomplete="off" class="form-control" placeholder=" @lang('commonmodule::site.title')" required name="{{$lang->display_lang}}[title]"
                                                >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            {{-- Slug --}}
                                            <label class="control-label col-sm-2" for="title"> @lang('commonmodule::site.slug') ({{ $lang->lang }}) :</label>
                                            <div class="col-sm-8">
                                                <input type="text" autocomplete="off" class="form-control" placeholder=" @lang('commonmodule::site.slug')" name="{{$lang->display_lang}}[slug]" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="ckeditor" name="{{$lang->display_lang}}[description]" placeholder="@lang('commonmodule::site.description')"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-2" for="title">@lang('commonmodule::site.parent_category'):</label>
                        <div class="col-sm-8">
