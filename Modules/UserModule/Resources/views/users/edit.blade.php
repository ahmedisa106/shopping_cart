            ...
            <form class="form-horizontal" action="{{route('users.update',$user->id)}}" method="POST">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="name" value="{{$user->name}}" class="form-control" placeholder="@lang('commonmodule::site.name')" required>
                            @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="email" name="email" value="{{$user->email}}" class="form-control" placeholder="@lang('commonmodule::site.email')" required>
                            @error('email')
                            <span class="text-danger">
                                {{$message}}
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="address" value="{{$user->address}}" class="form-control" placeholder="@lang('commonmodule::site.address')" required>
                            @error('address')
                            <span class="text-danger">
                                {{$message}}
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="phone" value="{{$user->phone}}" class="form-control" placeholder="@lang('commonmodule::site.phone')">
